...
public class AccountControllerTest {
    ...
    public void getAccountInfo() throws Exception {
        ...
        //响应时间
        given().param("siteId", 123456L).when().get("/v1/account").then().time(lessThan(100L), TimeUnit.MILLISECONDS).assertThat().body(matchesJsonSchemaInClasspath("json-schema/account-schema.json"));
